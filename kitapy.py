...
url = "https://www.kitapyurdu.com/index.php?route=product/best_sellers&list_id=1&filter_in_stock=1&filter_in_stock=1&limit=98"
...
file = open("kitap.doc","w", newline= "", encoding='utf-8')
...
for i in list:
    ...
    writer.writerow([s, title, yazar[s2], yayın[s2],fiyat[s2]])
    s2 += 1
    s += 1
print("Bitti")